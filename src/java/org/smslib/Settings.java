...
public class Settings
{
	...
	/**
	 * Specifies whether queue traffic should be included in the debug logging.
	 */
	...
	/**
	 * Specifies the interval for the awakening of the background sending queue
	 * (milliseconds).
	 */
	 ...
	 * outbound message befrore it classifies it as failed.
	 */
	...
	Settings()
	{
		if (System.getProperty("smslib.debug") != null) this.DEBUG = true;
		...
		if (System.getProperty("smslib.queue.interval") != null) this.QUEUE_INTERVAL = Integer.parseInt(System.getProperty("smslib.queue.interval"));
