...
public class ModemGateway extends AGateway
{
	...
	ModemGateway(ModemTypes type, String id, String myModemDevice, int myModemParms, String myManufacturer, String myModel)
	{
		...
		if (type == ModemTypes.SERIAL)
			this.driver = new SerialModemDriver(this, this.modemDevice + ":" + this.modemParms);
		else
			this.driver = new IPModemDriver(this, this.modemDevice + ":" + this.modemParms);
	...
	public boolean getGprsStatus() throws TimeoutException, GatewayException, IOException, InterruptedException
	{
		synchronized (this.driver.SYNC_Commander)
		{
